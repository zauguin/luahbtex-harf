...
\directlua{require'laharf'}
\font\testr="[lmroman10-regular.otf]:mode=buzz;script=latn;+dlig" at 10pt
\font\testb="[lmroman10-bold.otf]:mode=buzz;-liga;script=latn" at 10pt
\font\testi="[lmromanslant10-regular.otf]:mode=buzz;script=latn" at 10pt
\font\testR="[lmroman12-regular.otf]:mode=buzz;script=latn" at 12pt
\font\testA="[amiri-regular.ttf]:mode=buzz;script=arab" at 10pt
\font\testB="[amiri-bold.ttf]:mode=buzz;script=arab" at 10pt
\font\testF="[NotoSerifCJK-Regular.ttc]:mode=buzz;script=latn;" at 10pt
...
\hrule
\vskip 1in
\centerline{\testb A ff SHORT STORY}
\vskip 6pt
